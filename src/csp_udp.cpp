...
bool csp_udp_send(uint8_t pri, uint8_t src, uint8_t dst, uint8_t sport, uint8_t dport, uint8_t *payload, uint16_t payload_len, const char* remote_ip, uint16_t remote_port) {
    csp_id_t id;
    id.ext = 0;
    id.pri = pri & 0x03;
    id.src = src & 0x1F;
